class BossPresentationInterface {
    constructor(sound) {
      ...
      this.health = $("#health");
      this.counter = $("#hp");
      this.hearts = [$("#heart1"), $("#heart2"), $("#heart3"), $("#heart4"), $("#heart5"), $("#heart6"), $("#heart7"), $("#heart8"), $("#heart9"), $("#heart10")];
    ...
    {
      var ratio = currentHealth / maxHealth * 10
      var fullHearts = Math.ceil(ratio);
      var halfHeart = false;
      if(fullHearts - ratio >= .5)
      {
        halfHeart = true;
        fullHearts--;
      }
      ...
      {
        if(!this.hearts[i].hasClass("FullHeart"))
        {
          this.hearts[i].removeClass().addClass('FullHeart');
        }
      }
      if(halfHeart)
      {
        this.hearts[fullHearts].removeClass().addClass('HalfHeart');
        fullHearts++;
      }
      for(var i = fullHearts; i < 10; i++)
      {
        this.hearts[i].removeClass().addClass('EmptyHeart');
      }
    }
